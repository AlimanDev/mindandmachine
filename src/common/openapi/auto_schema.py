...
from src.common.openapi.overrides import overrides_info, overrides_pk, overrides_order
...
Для этого используется [HTTP Basic Auth](https://en.wikipedia.org/wiki/Basic_access_authentication) — отправка логина и пароля в заголовке HTTP запроса. 
        ...
        SWAGGER_SETTINGS_OVERRIDE['DEFAULT_AUTO_SCHEMA_CLASS'] = "src.common.openapi.auto_schema.WFMAutoSchemaIntegration"
