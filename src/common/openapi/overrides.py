from src.common.openapi.descriptions import SHOP_UPDATE, RECIEPT, WORKER_DAY_LIST, TIMESERIE_VALUE
from src.common.openapi.integration_serializers import (
...
from src.common.openapi.responses import worker_day_list_integration, receipt_integration
from src.interfaces.api.serializers.shop import ShopSerializer
from src.interfaces.api.serializers.base import UserSerializer, WorkerPositionSerializer, EmploymentSerializer
