...
class BaseFileTicksReportGenerator(BaseDocGenerator, BaseTicksReportGenerator):
    def get_data(self) -> dict:
        ...
        with open(os.path.join(settings.BASE_DIR, 'src/common/dg/templates/no_photo.png'), 'rb') as f:
            no_photo = f.read()
...
class TicksOdsReportGenerator(BaseFileTicksReportGenerator):
    def get_template_path(self) -> str:
        return os.path.join(settings.BASE_DIR, 'src/common/dg/templates/ticks_report.ods')
...
class TicksOdtReportGenerator(BaseFileTicksReportGenerator):
    def get_template_path(self) -> str:
        return os.path.join(settings.BASE_DIR, 'src/common/dg/templates/ticks_report.odt')
