...
from src.apps.timetable.models import TimesheetItem, WorkerDay, PlanAndFactHours, WorkerDayType, EmploymentWorkType
...
class T13TimesheetGenerator(BaseTimesheetGenerator):
    ...
    def get_template_path(self):
        return os.path.join(settings.BASE_DIR, 'src/common/dg/templates/t_13.ods')
...
class CustomT13TimesheetGenerator(T13TimesheetGenerator):
    ...
    def get_template_path(self):
        return os.path.join(settings.BASE_DIR, 'src/common/dg/templates/t_custom.ods')
...
class MTSTimesheetGenerator(BaseTimesheetGenerator):
    ...
    def get_template_path(self):
        return os.path.join(settings.BASE_DIR, 'src/common/dg/templates/t_mts.ods')
...
class DefaultTimesheetGenerator(BaseTimesheetGenerator):
    ...
    def get_template_path(self):
        ...
        return os.path.join(settings.BASE_DIR, f'src/common/dg/templates/{filename}.ods')
...
class TimesheetLinesGenerator(BaseTimesheetGenerator):
    ...
    def get_template_path(self):
        return os.path.join(settings.BASE_DIR, 'src/common/dg/templates/t_lines.ods')
