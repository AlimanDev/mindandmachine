            ...
            if timesheet.fact_timesheet_type.is_dayoff:
                ...
                fact_timesheet_items.append(
                    TimesheetItem(
                        ...
                        day_hours=timesheet.fact_timesheet_day_hours,
                        night_hours=timesheet.fact_timesheet_night_hours,
            ...
            if timesheet.main_timesheet_type.is_dayoff:
                ...
                main_timesheet_items.append(
                    TimesheetItem(
                        ...
                        dt=timesheet.dt,
                        day_type=timesheet.main_timesheet_type,
                        day_hours=timesheet.main_timesheet_day_hours,
                        night_hours=timesheet.main_timesheet_night_hours,
                        shop_id=timesheet.shop_id,
                    )
                )
