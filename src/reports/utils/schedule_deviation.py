...
def schedule_deviation_report(dt_from, dt_to, *args, title=None, in_memory=False, created_by_id=None, shop_ids=None, **kwargs):
    ...
    if include_extra_columns:
        ...
        worksheet.write_string(10, columns['supervisor_mentor'], 'НСВ', header_format)
    ...
    worksheet.write_string(10, columns['network_shop'], 'Закрепленная компания/магазиня', header_format)
