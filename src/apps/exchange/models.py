...
from src.adapters.filesystem.ftp import FtpEngine
from src.adapters.filesystem import LocalEngine
...
class FtpFilesystemConnector(BaseFilesystemConnector):
    ...
    def __str__(self):
        return self.name or f'filesystem fs connector {self.host}:{self.port} ({self.default_base_path})'
