# Generated by Django 2.2.7 on 2020-12-21 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(verbose_name='Год учетного периода', default=src.apps.base.models.current_year)),
                ('work_hours_by_months', django.contrib.postgres.fields.jsonb.JSONField(help_text='Сумма часов в рамках учетного периода должна быть равна сумме часов по произв. календарю.', verbose_name='Распределение рабочих часов по месяцам (в процентах)')),
                ('network', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='base.Network')),
                ('positions', models.ManyToManyField(blank=True, to='base.WorkerPosition', verbose_name='Позиции')),
                ('shops', models.ManyToManyField(blank=True, to='base.Shop', verbose_name='Подразделения')),
            ],
            options={
                ...
                'unique_together': {('code', 'year', 'network')},
            },
        ),
    ]
