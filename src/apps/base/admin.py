...
from src.apps.base.admin_filters import CustomChoiceDropdownFilter, RelatedOnlyDropdownLastNameOrderedFilter, \
    RelatedOnlyDropdownNameOrderedFilter
from src.apps.base.forms import (
...
from src.apps.base.shop.utils import get_offset_timezone_dict, get_shop_name
from src.apps.timetable.models import GroupWorkerDayPermission
...
class NetworkAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Timetable settings'), {'fields': (
            ...
            'request_approve_with_tasks_check',
        )}),
