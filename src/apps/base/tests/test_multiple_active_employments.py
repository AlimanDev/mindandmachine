...
from src.apps.med_docs.models import MedicalDocument, MedicalDocumentType
from src.apps.recognition.models import Tick
from src.apps.timetable.models import WorkerDay, WorkerDayPermission, GroupWorkerDayPermission
from src.apps.timetable.tests.factories import WorkerDayFactory, WorkTypeFactory
