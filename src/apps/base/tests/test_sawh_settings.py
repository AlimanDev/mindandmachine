...
from src.apps.base.tests.factories import (
    NetworkFactory,
    UserFactory,
    ShopFactory,
    EmploymentFactory,
...
from src.apps.timetable.models import WorkerDay, TimesheetItem
...
from src.apps.timetable.timesheet.utils import get_timesheet_stats
...
class SawhSettingsHelperMixin(TestsHelperMixin):
    ...
    def setUpTestData(cls):
        ...
        cls.worker_position = WorkerPositionFactory(group=cls.group, sawh_settings=cls.sawh_settings)
...
class TestSAWHSettingsQuarterAccPeriod(SawhSettingsHelperMixin, TestCase):
    ...
    def test_two_employments_case_one(self):
        ...
        worker_position2 = WorkerPositionFactory(network=self.network, sawh_settings=sawh_settings2)
        EmploymentFactory(
    ...
    def test_override_region_prod_cal(self):
        self.worker_position.sawh_settings = None
        self.worker_position.save()
