...
from src.apps.base.models import Employment, User, Shop, ShopSchedule, Employee, ShiftScheduleDay
from src.common.drf.filters import (
    ListFilter,
    QCharFilter,
    QNumberFilter,
    QListFilter,
...
from src.common.drf.filterset import QFilterSet
