...
from src.apps.base.models import FunctionGroup, Network, WorkerPosition
from src.apps.base.tests import EmployeeFactory, EmploymentFactory, GroupFactory, NetworkFactory, ShopFactory, \
    UserFactory, WorkerPositionFactory
from src.apps.recognition.models import Tick, TickPhoto, TickPoint
from src.apps.reports.models import ReportConfig, ReportType, Period, UserShopGroups, UserSubordinates, EmploymentStats
from src.apps.timetable.models import TimesheetItem
from src.apps.reports.reports import PIVOT_TABEL
from src.apps.reports.tasks import cron_report, fill_user_shop_groups, fill_user_subordinates, fill_employments_stats, tick_report, delete_reports
from src.apps.timetable.models import ScheduleDeviations, WorkerDay, WorkerDayOutsourceNetwork, WorkerDayType
from src.apps.timetable.tests.factories import WorkerDayFactory
from src.common.mixins.tests import TestsHelperMixin
from src.common import files
