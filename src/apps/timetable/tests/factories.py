...
from src.apps.base.tests.factories_abstract import AbstractActiveNamedModelFactory
from src.apps.timetable.models import WorkerDay, WorkerDayCashboxDetails, WorkType, WorkTypeName, EmploymentWorkType, WorkerDayType
