# Создано вручную 2022-10-03 11:15
# Обновляет v_plan_and_fact_hours_2y;

from django.db import migrations

def update_views(apps, schema_editor):
    schema_editor.execute("""
    CREATE OR REPLACE VIEW v_plan_and_fact_hours_2y AS
 SELECT tt_pf.dt AS "Дата",
  ...
  WHERE tt_pf.wd_type_id::text = 'W'::text AND tt_pf.dt > (CURRENT_DATE - '2 years'::interval)
UNION ALL
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('timetable', '0124_alter_restriction_is_vacancy'),
    ]
