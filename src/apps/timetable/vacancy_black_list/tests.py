...
from src.apps.timetable.models import VacancyBlackList, WorkerDay, WorkerDayCashboxDetails, WorkType, WorkTypeName
from src.apps.timetable.vacancy.utils import confirm_vacancy
