...
from src.apps.base.models import WorkerPosition, Employment
from src.apps.integration.models import AttendanceArea, ExternalSystem, UserExternalCode, ShopExternalCode
from src.apps.integration.tasks import import_urv_zkteco, export_workers_zkteco, delete_workers_zkteco
from src.apps.timetable.tests.factories import WorkTypeFactory, WorkTypeNameFactory
...
class TestIntegration(TestsHelperMixin, APITestCase):
    ...
    def test_export_workers(self):
        ...
        with patch('src.apps.integration.zkteco.requests', new_callable=TestRequestMock) as mock_request:
    ...
    def test_export_worker_on_employment_change(self):
        ...
        with patch.object(transaction, 'on_commit', lambda t: t()):
            with patch('src.apps.integration.zkteco.requests', spec=TestRequestMock) as mock_request:
    ...
    def test_fact_not_duplicated_on_approve(self):
        ...
        with patch('src.apps.integration.zkteco.requests', new_callable=TestRequestMock):
            import_urv_zkteco()
