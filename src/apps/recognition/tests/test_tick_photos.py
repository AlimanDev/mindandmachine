...
from src.apps.recognition.models import Tick, TickPhoto, UserConnecter
from src.adapters.tevian.recognition import Recognition, Tevian
from src.apps.timetable.models import WorkerDay
from src.common.mixins.tests import TestsHelperMixin
from src.common.mock import mock_request
...
class TestTickPhotos(TestsHelperMixin, APITestCase):
    ...
    def _test_lateness(self, type, photo_type, dttm, assert_lateness, tick_id=None, assert_tick_lateness=True):
        with mock.patch('src.apps.recognition.views.now', lambda: dttm - timedelta(hours=3)):
