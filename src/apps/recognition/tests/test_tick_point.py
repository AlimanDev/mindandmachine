...
from src.apps.base.tests import NetworkFactory, ShopFactory, UserFactory, GroupFactory, EmploymentFactory, EmployeeFactory
from src.apps.recognition.models import ShopIpAddress, TickPoint
