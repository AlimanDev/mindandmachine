    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt', models.DateField()),
                ('shift_schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='days', to='base.shiftschedule', verbose_name='График смен')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.employee', verbose_name='Сотрудник')),
                ('shift_schedule', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='base.shiftschedule', verbose_name='График смен')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ShiftScheduleDayItem',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dttm_modified', models.DateTimeField(auto_now=True)),
                ('code', models.CharField(blank=True, db_index=True, max_length=256, null=True)),
                ('hours_type', models.CharField(choices=[('D', 'Дневное (явка)'), ('E', 'Вечернее'), ('N', 'Ночное'), ('W', 'Вахта')], default='D', max_length=2)),
                ('hours_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=4)),
                ('shift_schedule_day', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='base.shiftscheduleday')),
            ],
            options={
                'verbose_name': 'Элемент дня графика смен',
                'verbose_name_plural': 'Элементы дня графика смен',
                'abstract': False,
                'unique_together': {('hours_type', 'shift_schedule_day')},
            },
            bases=(src.util.mixins.bulk_update_or_create.BatchUpdateOrCreateModelMixin, models.Model),
        ),
    ]
