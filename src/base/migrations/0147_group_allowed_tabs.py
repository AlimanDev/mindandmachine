...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='group',
            name='allowed_tabs',
            field=src.base.fields.MultipleChoiceField(choices=[('load_forecast', 'Прогноз потребностей'), ('schedule', 'Расписание'), ('employees', 'Сотрудники'), ('shift_exchange', 'Биржа смен'), ('analytics', 'Аналитика'), ('settings', 'Настройки')], default='[]'),
        ),
