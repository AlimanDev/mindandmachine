...
def forwards_func(apps, schema_editor):
    ...
    ShopSettings = apps.get_model("base", "ShopSettings")
    db_alias = schema_editor.connection.alias
    shops = Shop.objects.all()
    for shop in shops:
        settings = ShopSettings.objects.using(db_alias).create(
            name=shop.name,
            method_params=shop.method_params,
            cost_weights=shop.cost_weights,
            init_params=shop.init_params,
            ...
            even_shift_morning_evening=shop.even_shift_morning_evening,
            ...
            queue_length=shop.queue_length,
            max_work_hours_7days=shop.max_work_hours_7days,
        )
