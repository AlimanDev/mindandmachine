    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_hours_by_months', django.contrib.postgres.fields.jsonb.JSONField(default=src.base.models.default_work_hours_by_months, help_text='Сумма часов в рамках учетного периода должна быть равна сумме часов по произв. календарю.', verbose_name='Распределение рабочих часов по месяцам (в процентах)')),
