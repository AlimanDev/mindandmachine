    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=src.base.models.current_year, verbose_name='Год учетного периода')),
                ('priority', models.PositiveSmallIntegerField(default=0)),
                ('exclude_positions', models.ManyToManyField(blank=True, related_name='_sawhsettingsmapping_exclude_positions_+', to='base.WorkerPosition')),
                ('positions', models.ManyToManyField(blank=True, related_name='_sawhsettingsmapping_positions_+', to='base.WorkerPosition')),
                ('sawh_settings', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.SAWHSettings', verbose_name='Настройки СУРВ')),
                ('shops', models.ManyToManyField(blank=True, to='base.Shop')),
            ],
            options={
