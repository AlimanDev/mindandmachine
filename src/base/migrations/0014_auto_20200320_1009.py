# Generated by Django 2.2.7 on 2020-03-20 10:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='event',
            name='type',
            field=models.CharField(choices=[('V', 'Вакансия'), ('T', 'Изменения в расписании')], max_length=1),
        ),
        migrations.AlterField(
