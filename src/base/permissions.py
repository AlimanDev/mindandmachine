...
class WdPermission(Permission):
    def has_permission(self, request, view):
        ...
        if view_action in ['create', 'update']:
            ...
            ) and WorkerDay._has_group_permissions(request.user, request.data.get('employee_id'), request.data.get('dt'), request.data.get('shop_id'))
            ...
            ) and WorkerDay._has_group_permissions(request.user, wd_dict.get('employee_id'), wd_dict.get('dt'), wd_dict.get('shop_id'))
