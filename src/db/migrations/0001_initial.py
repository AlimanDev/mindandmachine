    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_info', models.CharField(default='', max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', src.db.utils.EnumField(to_enum=[0])),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('worker', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('worker_shop',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='db.Shop')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('worker_day', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='db.WorkerDay')),
                ('worker_day_worker', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    to='db.WorkerDayChangeLog'),
        ),
        migrations.AddField(
            model_name='notifications',
            name='worker_day_change_request',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    to='db.WorkerDayChangeRequest'),
        ),
        migrations.AddField(
