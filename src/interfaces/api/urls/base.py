...
from src.interfaces.api.views.auth import (
    WFMTokenLoginView,
    OneTimePassView,
)
from src.interfaces.api.views.shop import ShopViewSet
from src.interfaces.api.views.base import (
    ContentBlockViewSet,
    EmploymentViewSet,
    UserViewSet,
    FunctionGroupView,
    ...
    BreakViewSet,
    ShopScheduleViewSet,
    EmployeeViewSet, RegionViewSet,
)
from src.interfaces.api.views.sawh_settings import SAWHSettingsViewSet
from src.interfaces.api.views.shift_schedule import (
...
urlpatterns = [
    ...
    re_path(r'^tevian-auth/', include('rest_framework.urls', namespace='rest_framework')),
