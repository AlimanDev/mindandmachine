...
from src.apps.base.pagination import LimitOffsetPaginationWithOptionalCount

from src.apps.base.exceptions import FieldError
from src.apps.base.models import Employment, Shop, Employee
from src.apps.base.permissions import WdPermission
from src.apps.base.views_abstract import BaseActiveNamedModelViewSet
...
from src.apps.timetable.backends import MultiShopsFilterBackend
from src.apps.timetable.events import REQUEST_APPROVE_EVENT_TYPE, REQUEST_APPROVE_WITH_TASKS_EVENT_TYPE
from src.apps.timetable.filters import WorkerDayFilter, WorkerDayStatFilter, VacancyFilter
...
from src.apps.timetable.vacancy.utils import cancel_vacancies, cancel_vacancy, confirm_vacancy, notify_vacancy_created
from src.interfaces.api.serializers.worker_day import (
...
from src.apps.timetable.worker_day.stat import count_daily_stat
from src.apps.timetable.worker_day.tasks import recalc_work_hours, batch_block_or_unblock
from src.apps.timetable.worker_day.services.timetable import get_timetable_generator_cls
from src.apps.timetable.worker_day.services.approve import WorkerDayApproveService
from src.apps.timetable.worker_day.utils.utils import create_worker_days_range, exchange, \
    copy_as_excel_cells, ERROR_MESSAGES
from src.common.dg.timesheet import get_tabel_generator_cls
from src.common.models_converter import Converter
from src.common.openapi.responses import (
...
class WorkerDayViewSet(BaseActiveNamedModelViewSet):
    ...
    def download_tabel(self, request):
        ...
        tabel_generator = tabel_generator_cls(shop, dt_from, dt_to, timesheet_types=timesheet_type)
        ...
        filename = _('{}_timesheet_for_shop_{}_from_{}.{}').format(
            '_'.join(str(name) for type, name in TimesheetItem.TIMESHEET_TYPE_CHOICES if type in timesheet_type),
            shop.code,
