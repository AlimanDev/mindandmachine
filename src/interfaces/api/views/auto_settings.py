...
from src.interfaces.api.serializers.auto_settings import (
    AutoSettingsCreateSerializer,
    AutoSettingsDeleteSerializer,
    AutoSettingsSetSerializer,
)
from src.apps.timetable.auto_settings.autosettings import AutoSettings
...
class AutoSettingsViewSet(viewsets.ViewSet):
    ...
    def delete_timetable(self, request):
        ...
        Args:
            method: POST
            url: /tevian/timetable/auto_settings/delete_timetable
