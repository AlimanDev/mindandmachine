...
from src.apps.timetable.models import WorkerDay, WorkerDayCashboxDetails, Shop, User
from src.interfaces.api.serializers.base import BaseModelSerializer, BaseSerializer, NetworkSerializer
