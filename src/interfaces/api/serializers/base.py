...
from src.apps.base.fields import CurrentUserNetwork, UserworkShop
...
from src.interfaces.api.serializers.timetable import EmploymentWorkTypeSerializer, EmploymentWorkTypeListSerializer
from src.interfaces.api.serializers.worker_constraint import WorkerConstraintSerializer, WorkerConstraintListSerializer
    ...
    def __init__(self, *args, user_source=None, **kwargs):
        ...
        if request:
            ...
            if include_medical_documents and bool(distutils.util.strtobool(include_medical_documents)):
                from src.interfaces.api.serializers.med_docs import MedicalDocumentSerializer
