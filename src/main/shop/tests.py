        ...
        data = {
            ...
            'shops': [
                {'id': self.reg_shop2.id,
                 ...
                 'timezone': 'Europe/Moscow',
                 'name': 'Region Shop2', 'tm_shop_opens': '07:00:00', 'tm_shop_closes': '00:00:00', 'code': None, 'address': None, 'type': 's', 'dt_opened': None, 'dt_closed': None,
                ...
                {'id': self.reg_shop1.id,
                 'parent_id': self.root_shop.id,
                 'timezone': 'Europe/Moscow',
                 'name': 'Region Shop1', 'tm_shop_opens': '07:00:00', 'tm_shop_closes': '00:00:00', 'code': None, 'address': None, 'type': 's', 'dt_opened': None, 'dt_closed': None,
