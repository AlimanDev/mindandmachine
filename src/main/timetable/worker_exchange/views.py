...
def get_workers_to_exchange(request, form):
    ...
    # from_other_spec(shop_id, dttm_exchange, ct_type, predict_demand, mean_bills_per_step, cashbox_types_hard)

    day_switch(shop_id, dttm_exchange, ct_type, predict_demand, mean_bills_per_step, cashbox_types_hard)
